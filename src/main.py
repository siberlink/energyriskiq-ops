...
def main():
    ...
    parser.add_argument('--mode', choices=['api', 'ingest', 'ai', 'risk'], default='api',
                        help='Run mode: api (start server), ingest (run ingestion), ai (run AI processing), risk (run risk scoring)')
