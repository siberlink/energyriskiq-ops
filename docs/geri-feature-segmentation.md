# GERI — User Dashboard Feature Segmentation

Optimized for existing data assets: GERI + Brent + TTF + VIX + EUR/USD + EU Gas Storage

---

## Free User Plan (Dashboard Access Level 1)
...
#### 1. GERI Snapshot Panel

User sees:
- Today's GERI value
- Risk Band label
- Arrow trend (Up / Down / Stable)

#### 2. Mini Trend Panel

- 7-day sparkline only
- No zoom
- No historical navigation

#### 3. Simplified Drivers Panel

Shows top 3 macro categories only:
- Geopolitical
- Energy Supply
- Market Stress
...
**Limit:** Last 14 days only

#### Overlay Capability

- ONE preset chart only: **GERI vs Brent** (fixed)
- No switching assets
- No toggles
- No smoothing
- No controls
...
Auto-generated 2–3 sentence explanation of current risk level.

---

## Personal Plan — $9.95 (Dashboard Access Level 2)
...
#### 1. Extended GERI Snapshot

Adds:
- 30-day trend summary
- Risk direction indicator
- "Watch next" signals (simple)

#### 2. Drivers Panel (Expanded)
...
**Limit:** Only ONE asset overlay at a time
...
- Simple divergence labels

Example: *"GERI rising while Brent flat"*

---

## Trader Plan — $29 (Dashboard Access Level 3)
...
#### 2. Asset Sensitivity Panel

Shows:
- Assets currently most responsive to risk
- Directional bias (Up / Down / Neutral)

#### 3. Expanded Drivers Intelligence

Adds:
- Top drivers ranked by impact
- Region heat tagging
- Driver trend direction

### Charts Module

#### GERI History

**Range:** Full historical lifecycle

#### Overlay Engine

Allows up to **TWO simultaneous overlays**
...
Chart automatically highlights:
- Risk leading assets
- Asset leading risk
- Decoupling zones

#### EU Storage Analytics

Adds seasonal comparison baseline (extremely valuable to traders).

---

## Pro Plan — $49 (Dashboard Access Level 4 – Live GERI)

**Goal:**
- Institutional-grade analytical dashboard
- Full explainability
- Multi-asset systemic analysis

### Dashboard Panels

Everything from Trader plus:

#### 1. Live GERI Intelligence Panel

Adds:
- Signal confidence level
- Daily change decomposition
- "What changed since yesterday" explanation

#### 2. Systemic Risk Narrative Panel

AI-generated analyst brief summarizing:
- Major risk forces
- Cross-market implications
- Forward monitoring themes

#### 3. Event Cluster Panel

Groups drivers into clusters:
- Sanctions
- Transit disruption
- LNG stress
- Conflict escalation
...
Up to **FOUR simultaneous overlays**

#### Advanced Chart Types

Adds:
- Rolling correlation chart
- Volatility comparison view
- Asset response strength scoring
...
## Enterprise Plan — $129 (Dashboard Access Level 5)

**Goal:**
- Team decision intelligence
- Custom analytics workspace
- Professional risk monitoring environment

### Dashboard Panels

Everything from Pro plus:

#### 1. Multi-Workspace Dashboard

Organizations can:
- Save multiple layouts
- Create desk-specific dashboards
- Share dashboards internally

#### 2. Custom Risk Band Settings

Organizations can define:
- Their own alert thresholds
- Custom interpretation labels

#### 3. Team Activity Panels

Shows:
- Shared annotations
- Team commentary
- Shared flagged risk events

### Charts Module

#### Unlimited Overlay Engine
...
- Build internal derived indicators
- Save overlay templates

---

## Feature Escalation Logic (Pricing Ladder)
...
Because EnergyRiskIQ has:
- Full lifecycle GERI data
- Multi-asset overlays
- EU Storage seasonal data
- AI driver classification

The following features can be safely gated as premium:
- **Full history**
- **Multi-overlay**
- **Explainability**
- **Divergence analytics**
