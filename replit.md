...
- **RERI (Regional Escalation Risk Index):** Planned regional-level index for tactical, fast-moving risk assessment per region. See `docs/indices-bible.md` for architecture guidance.
